...
function toApiHistory(initial: InitialChatMessage[]): ApiHistoryEntry[] {
  ...
  for (const row of initial) {
    // Reshape persisted tool_result rows (stored separately for analytics)
    // into user-turn content blocks — the Anthropic API requires a user
    // tool_result block immediately after each assistant tool_use.
