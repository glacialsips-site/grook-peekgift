...
/**
 * Fill missing dials on a partial vibe with DEFAULT_VIBE values. Defined dials
 * are preserved verbatim. `signal_source_history` passes through untouched.
 */
...
/**
 * True when no curator/system signal has been recorded yet
 * (`signal_source_history` is empty or absent).
 */
...
/** Convenience for tests/seed scripts; fills missing dials from DEFAULT_VIBE. */
