...
const schema = z.object({
  ...
  // Max 50 KB matches the curator_memory.size_bytes CHECK constraint in
  // migration 0013; higher values would insert-then-CHECK-fail with a raw
  // Postgres error instead of the protocol's "File too large" string.
